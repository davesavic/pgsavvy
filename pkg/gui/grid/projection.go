...
//
// Filter is implemented in filter.go; hide-cols
// keeps its no-op slot here for symmetry — the hide
...
// in order).
//
// The in-grid regex row-filter was replaced by a
...
// applyHideCols is the hide-cols placeholder. Hide is a
