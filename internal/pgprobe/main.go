...
// It connects to the DSN given as the first argument (or DBSAVVY_TEST_PG) and
...
func main() {
	...
	if dsn == "" {
		fmt.Fprintln(os.Stderr, "pgprobe: no DSN (set DBSAVVY_TEST_PG or pass it as the first argument)")
		os.Exit(1)
	}
